...
import { type ConnectorAccountNotFoundErrorType, type ConnectorChainMismatchErrorType, type ConnectorNotConnectedErrorType } from '../errors/config.js';
...
export type GetConnectorClientErrorType = ConnectorAccountNotFoundErrorType | ConnectorChainMismatchErrorType | ConnectorNotConnectedErrorType | BaseErrorType | ErrorType;
